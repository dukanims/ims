...
(function () {
  ...
  const STR = {
    en: {
      ...
      ph_username: "e.g. admin or finance", ph_password: "Your password", sign_in: "Sign in",
      hero_eyebrow: "College & Institute Edition",
      hero_title: "Track every student internship, department by department.",
      ...
      brand_sub: "Internship Management System",
      ...
      ph_search_student: "Search name or ID…", all_times: "All study times", morning: "Morning", evening: "Evening",
      c_fullname: "Full name", c_studentid: "Student ID", c_major: "Department / Major", c_stage: "Stage", c_studytime: "Study time",
      e_nostudents_t: "No students yet", e_nostudents_s: "Click “Add student” to register your first student.",
      ...
      e_norep_t: "Nothing to report", e_norep_s: "Add students to generate a report.",
      ...
      backup_all: "Backup all data", reset_all: "Reset all data",
      import_students: "+ Import (CSV)", m_import_title: "Import students",
      import_help: "Upload a CSV with columns: Full name, Student ID, Department, Stage, Study time. Kurdish or English values are both accepted.",
    ...
    ku: {
      ...
      ph_username: "وەک admin یان finance", ph_password: "وشەی نهێنییەکەت", sign_in: "چوونەژوورەوە",
      hero_eyebrow: "وەشانی کۆلێژ و پەیمانگا",
      hero_title: "هەموو ڕاهێنانێکی خوێندکار بەدوابکە، بەش بەش.",
      ...
      brand_sub: "سیستەمی بەڕێوەبردنی ڕاهێنان",
      ...
      ph_search_student: "گەڕان بە ناو یان ناسنامە…", all_times: "هەموو کاتەکانی خوێندن", morning: "بەیانی", evening: "ئێوارە",
      c_fullname: "ناوی تەواو", c_studentid: "ناسنامەی خوێندکار", c_major: "بەش / پسپۆڕی", c_stage: "قۆناغ", c_studytime: "کاتی خوێندن",
      e_nostudents_t: "هێشتا هیچ خوێندکارێک نییە", e_nostudents_s: "کلیک لە «زیادکردنی خوێندکار» بکە بۆ تۆمارکردنی یەکەم خوێندکار.",
      ...
      e_norep_t: "هیچ شتێک بۆ ڕاپۆرت نییە", e_norep_s: "خوێندکار زیاد بکە بۆ دروستکردنی ڕاپۆرت.",
      ...
      backup_all: "باکئەپی هەموو داتا", reset_all: "سفرکردنەوەی هەموو داتا",
      import_students: "+ زیادکردن (CSV)", m_import_title: "زیادکردنی خوێندکاران بەکۆمەڵ",
      import_help: "فایلێکی CSV بەرز بکەرەوە بەم ستوونانە: ناوی تەواو، ناسنامە، بەش، قۆناغ، کاتی خوێندن. هەم کوردی هەم ئینگلیزی قبوڵ دەکرێت.",
