...
(function () {
  ...
  const STR = {
    en: {
      ...
      super_admin: "Super Admin", administrator: "Administrator", department_role: "{d} unit", ragr_role: "Institute Dean",
    ...
    ku: {
      ...
      super_admin: "بەڕێوەبەری سەرەکی", administrator: "بەڕێوەبەر", department_role: "هۆبەی {d}", ragr_role: "ڕاگری پەیمانگا",
