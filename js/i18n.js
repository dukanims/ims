...
(function () {
  ...
  const STR = {
    en: {
      ...
      nav_history: "History", t_history: "Change history", s_history: "Who changed what, and when", eb_history: "Audit", h_history_h: "Change history", hist_by: "Changed by", hist_when: "Time", hist_empty_t: "No history yet", hist_empty_s: "Status changes will appear here as staff update students.", ph_search_history: "Search student, department or user…",
    ...
    ku: {
      ...
      nav_history: "مێژوو", t_history: "مێژووی گۆڕانکاری", s_history: "کێ چی گۆڕی، و کەی", eb_history: "بەدواداچوون", h_history_h: "مێژووی گۆڕانکاری", hist_by: "گۆڕدرا لەلایەن", hist_when: "کات", hist_empty_t: "هێشتا هیچ مێژوویەک نییە", hist_empty_s: "گۆڕانکاریی دۆخەکان لێرە دەردەکەون کاتێک کارمەندان خوێندکاران نوێ دەکەنەوە.", ph_search_history: "گەڕان بە خوێندکار، بەش یان بەکارهێنەر…",
