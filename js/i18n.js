...
(function () {
  ...
  const STR = {
    en: {
      ...
      bk_title: "Time to back up", bk_never: "You haven't made a backup yet. Download one to keep your data safe.", bk_stale: "Your last backup was {n} days ago. It's a good time to make a new one.", bk_now: "Back up now",
    ...
    ku: {
      ...
      bk_title: "کاتی باکئەپکردنە", bk_never: "هێشتا هیچ باکئەپێکت نەکردووە. یەکێک دابگرە بۆ پاراستنی داتاکەت.", bk_now: "ئێستا باکئەپ بکە", bk_stale: "دوایین باکئەپت {n} ڕۆژ لەمەوپێش بوو. کاتێکی باشە بۆ دروستکردنی یەکێکی نوێ.",
