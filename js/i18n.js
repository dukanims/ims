...
(function () {
  ...
  const STR = {
    en: {
      ...
      super_admin: "Super Admin", administrator: "Administrator", department_role: "{d} unit", ragr_role: "Institute Dean", ragr_report: "Report",
      ...
      ph_major_select: "Select department", all_majors: "All departments", all_stages: "All stages",
      ...
      btn_preview: "Preview", imp_preview_title: "Import preview", imp_new: "New", imp_update: "Update", imp_warn: "Needs review", imp_action: "Action", imp_confirm: "Confirm import", imp_warn_hint: "Rows highlighted in amber have a department or study time that was not recognised — check them, but you can still import.",
      card_btn: "Card", card_title: "Student Internship Clearance Form", card_org1: "Sulaimani Polytechnic University", card_org2: "Dukan Technical Institute", card_overall: "Overall status", card_cleared: "Overall clearance completed", card_notcleared: "Overall clearance not completed",
      nav_history: "History", t_history: "Change history", s_history: "", eb_history: "Audit", h_history_h: "Change history", hist_by: "Changed by", hist_when: "Time", hist_clear: "Clear history", hist_clear_title: "Clear change history", hist_clear_msg: "This permanently deletes all change-history records. Students and their statuses are not affected. Continue?", to_hist_cleared: "History cleared", hist_empty_t: "No history yet", hist_empty_s: "Status changes will appear here as staff update students.", ph_search_history: "Search student, department or user…",
      bk_title: "Time to back up", bk_never: "You haven't made a backup yet. Download one to keep your data safe.", bk_stale: "Your last backup was {n} days ago. It's a good time to make a new one.", bk_now: "Back up now", bk_later: "Not now",
    ...
    ku: {
      ...
      super_admin: "بەڕێوەبەری سەرەکی", administrator: "بەڕێوەبەر", department_role: "هۆبەی {d}", ragr_role: "ڕاگری پەیمانگا", ragr_report: "ڕاپۆرت",
      ...
      ph_major_select: "بەش هەڵبژێرە", all_majors: "هەموو بەشەکان", all_stages: "هەموو قۆناغەکان",
      ...
      btn_preview: "پێشبینین", imp_preview_title: "پێشبینینی هاوردەکردن", imp_new: "نوێ", imp_update: "نوێکردنەوە", imp_warn: "پێویستی بە پشکنین", imp_action: "کردار", imp_confirm: "پشتڕاستکردنەوەی هاوردە", imp_warn_hint: "ئەو ڕیزانەی بە ڕەنگی زەرد نیشانکراون، بەش یان کاتی خوێندنیان نەناسراوەتەوە — بیانپشکنە، بەڵام هێشتا دەتوانیت هاوردەیان بکەیت.",
      card_btn: "کارت", card_title: "فۆڕمی ئەستۆپاکی خوێندکاران", card_org1: "سەرۆکایەتی زانکۆی پۆلیتەکنیکی سلێمانی", card_org2: "پەیمانگای تەکنیکی دوکان", card_overall: "دۆخی گشتی", card_cleared: "ئەستۆپاکی گشتی تەواو بووە", card_notcleared: "ئەستۆپاکی گشتی تەواو نەبووە",
      nav_history: "مێژوو", t_history: "مێژووی گۆڕانکاری", s_history: "", eb_history: "بەدواداچوون", h_history_h: "مێژووی گۆڕانکاری", hist_by: "گۆڕدرا لەلایەن", hist_when: "کات", hist_clear: "پاککردنەوەی مێژوو", hist_clear_title: "پاککردنەوەی مێژووی گۆڕانکاری", hist_clear_msg: "ئەمە هەموو تۆمارەکانی مێژووی گۆڕانکاری بۆ هەمیشە دەسڕێتەوە. خوێندکاران و دۆخەکانیان کاریگەر نابن. بەردەوام دەبیت؟", to_hist_cleared: "مێژوو پاککرایەوە", hist_empty_t: "هێشتا هیچ مێژوویەک نییە", hist_empty_s: "گۆڕانکاریی دۆخەکان لێرە دەردەکەون کاتێک کارمەندان خوێندکاران نوێ دەکەنەوە.", ph_search_history: "گەڕان بە خوێندکار، بەش یان بەکارهێنەر…",
      bk_title: "کاتی باکئەپکردنە", bk_never: "هێشتا هیچ باکئەپێکت نەکردووە. یەکێک دابگرە بۆ پاراستنی داتاکەت.", bk_now: "ئێستا باکئەپ بکە", bk_later: "ئێستا نا", bk_stale: "دوایین باکئەپت {n} ڕۆژ لەمەوپێش بوو. کاتێکی باشە بۆ دروستکردنی یەکێکی نوێ.",
